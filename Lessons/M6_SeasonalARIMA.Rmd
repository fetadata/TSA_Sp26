...
```{r}
arima1 <- Arima(ts_electricity_price[,"Residential"], order = c(0,1,1), seasonal = c(0,1,1))
print(arima1)
compareaic <- data.frame(arima1$aic)


arima1 <- Arima(ts_electricity_price[,"Residential"], order = c(1,1,1), seasonal = c(0,1,1))
print(arima2)

checkresiduals(arima1)
checkresiduals(arima2)
compareaic <- data.frame(compareaic, arima2$aic)
...
model_autofit <- auto.arima(ts_electricity_price[,"Residential"],
                             approximation = T)
print(model_autofit)
compareaic <- data.frame(compareaic, model_autofit$aic)
...
compareaic <- data.frame(compareaic, model_autofit_nonseas$aic)
