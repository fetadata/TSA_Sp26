...
Pacf(ts_inflow_data[,iHP], lag.max = 40)
Pacf(ts_detrend_inflow, lag.max = 40)
...
seasonalmeansmodel <- lm(detrend_inflow_data~dummies)
summary(seasonalmeansmodel)

#store coefficients
beta_int <- seasonalmeansmodel$coefficients[1]
beta_coeff <- seasonalmeansmodel$coefficients[2:12]
