...
> Answer: The ACF plot of an AR(2) series would demonstrate a slow decay, while the PACF plot would show 2 significant lags. 

-   MA(1)

> Answer: the ACF plot of an MA(1) series would show one significant lag, and a long tail in the PACF. 
